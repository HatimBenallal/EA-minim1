...
import { SettingsComponent } from './components/settingFolder/settings/settings.component';

import { SettingComponent } from './components/settingFolder/setting/setting.component';
import { FormsettingsComponent } from './components/settingFolder/formsettings/formsettings.component';
...
const routes: Routes = [
  ...
  {path: "settings/:id", component: SettingComponent,resolve: {routeData: SettingsResolver}},
  {path: "formsettings", component: FormsettingsComponent},
